...
<body>
    ...
    <div class="content">
    	<ul class="xcxList" id="widget-box">
        	<li>
            	<a href="${pageContext.request.contextPath}/admin/createApplets">
                	<span><img src="${pageContext.request.contextPath}/images/icon.jpg"></span>
                    <p>创建新小程序</p>
                </a>
            </li>
            <li>
            	<div class="pic_zs">
                	<a class="brand_name" href="#"><img src="${pageContext.request.contextPath}/images/pic.jpg"></a>
                    <em class="yfb"></em>
                    <div class="bghs"></div>
                    <div class="brand_detail">
                    	<div class="xxList">
                        	<span><a href="#">预 览</a></span>
                            <span><a href="#">管 理</a></span>
                            <span><a href="bj.html">编 辑</a></span>
                        </div>
                        <div id="list">
                       	 <div class="cdList">
                                <span class="fzxcx"></span>
                                <div class="fzIconCon">
                                    <em></em>
                                    复制小程序
                                </div>
                ...
                <div class="tt_all">
                	<span class="x_hover">杂志封面设计</span>
                    <span class="time_cj">2015-07-09</span>
                </div>
            </li>
            <li>
            	<div class="pic_zs">
...
<div class="tanchu">
    <div class="tc_con">
    	<div class="gbCon">是否复制小程序？</div>
    	<span class="addsjdx"><a href="#">确定</a></span>
        <span class="gbBnt">关 闭</span>
    </div>
</div>
 <!--弹出框2-->
<div class="blackbgA"></div>
<div class="tanchuA">
    <div class="tc_con">
    	<div class="gbCon">是否确认删除？</div>
    	<span class="addsjdx"><a href="#">确定</a></span>
        <span class="gbBnt">关 闭</span>
    </div>
</div>
